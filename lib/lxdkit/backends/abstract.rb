...
module LXDKit
  ...
  module Backend
    ...
    MethodUnavailableError = Class.new(LXDKit::StandardError)
    ...
    #
    #   on(:local) do
    #     self == LXDKit::Backend.current # => true
    #   end
    #
    def self.current
    ...
    class Abstract
      ...
      def command(args, options)
        LXDKit::Command.new(*args, options.merge({in: pwd_path, env: @env, host: @host, user: @user, group: @group}))
      end
